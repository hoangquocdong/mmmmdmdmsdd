...
global $_content, $_menu, $_modun, $_htmlpath, $userid, $token, $crpage, $crmenu, $crpcid, $crsubid, $crmeter, $crnamesub, $crmonth;
...
$page =  (isset($_REQUEST['page'])) ? $_REQUEST['page']: 'login';
	...
	//echo '<pre>';
	//print_r($crposarr);
	$crpage=$crmenu=$crpcid=$crsubid=$crmeter=$crnamesub = $crmonth= '1111';
	...
	if (isset($crposarr[6])){ $crmonth = $crposarr[6];} else {$crmonth = '';}
