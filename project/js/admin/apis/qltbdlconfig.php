  ...
  CONNECT_DB();
    ...
    */
	...
	function getmeterinfo($idsub, $validated){
		$idsub = (int)$idsub;
		$sql='SELECT `ID`, `id_sub`, `id_pwc`, `id_invester`, `serial_meter`, `version_meter`, `level_meter`,
					 `name_meter`, `wiring_meter`, `factor_meter`, `lineloss_meter`, `pconvert_meter`, 
					 `levelvoltage_meter`,  `orderphase_meter`, `unit_meter`, `port_transmission_meter`, 
					 `count_point_meter`, `online_status`, `manufacturer_meter`, `original_meter`, `type_meter`, 
					 `year_production`,  `ampe_meter`, `exactlevel_meter`, `timestart_meter`, `location_meter`, 
					 `relation_meter`, `lasttime_programming`, `count_programming`, `status_meter` 
		...
		while($row = mysql_fetch_array($result)){
			...
			$tmp = array(
					...
					'wiring_meter' => $row['wiring_meter'],
					'factor_meter' => $row['factor_meter'],
					'lineloss_meter' => $row['lineloss_meter'],
					'pconvert_meter' => $row['pconvert_meter'],
					'levelvoltage_meter' => $row['levelvoltage_meter'],
					'orderphase_meter' => $row['orderphase_meter'],
					'unit_meter' => $row['unit_meter'],
					'port_transmission_meter' => $row['port_transmission_meter'],
