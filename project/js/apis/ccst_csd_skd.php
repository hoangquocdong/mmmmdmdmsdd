<?php
/*
*	Nhập chỉ số đầu - sau kiểm định.
* 	Để cho chắc chắn thì phải kiểm tra cả trường hợp xem đã confirm chưa -> rồi thì ko cho up trước/sau kiểm định nữa
*/
...
*/
  ...
  CONNECT_DB();
    ...
    function tkd_record_exist($serial, $month){

    	/*
    	*	Kiểm tra xem có đầu kỳ chưa (type=1) nếu ko có loai luôn ko cần kiểm tra type = 0 (th xác nhận thường)
    	*/
	...
	if (tkd_record_exist($serial, $month)) die('409');
